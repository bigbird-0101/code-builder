...
public class TableToJavaTool {
	...
	public void process(boolean beanFlag,boolean controllFlag,boolean serviceImplFlag,boolean daoFlag ) {
		List<String> tableNameS = getAllTableName();

		for (String tableName : tableNameS) {
			process(tableName,beanFlag,controllFlag,serviceImplFlag,daoFlag);
		}
	}

	public void process(String tableName,boolean beanFlag,boolean controllFlag,boolean serviceImplFlag,boolean daoFlag) {
		...
		//生成controller 文件
		if(controllFlag) {
			createJavaControllerFile(tableName,completeUrl+"\\controller",getPackName(srcUrl+"\\controller"));
		}

		//生成service 文件
		if(serviceImplFlag) {
			createJavaServiceFile(tableName,completeUrl+"\\service\\inter",getPackName(srcUrl+"\\service\\inter"));
		}

		//生成serviceImpl 文件
		if(serviceImplFlag) {
			createJavaServiceImplFile(tableName,completeUrl+"\\service\\impl",getPackName(srcUrl+"\\service\\impl"));
		}

		//生成Dao 文件
		if(daoFlag) {
			createJavaDaoFile(tableName,completeUrl+"\\dao",getPackName(srcUrl+"\\dao"));
		}
	...
	private void createJavaDaoFile(String tableName, String daoFileUrl,String packageName) {
		...
		jbString.append("	/**\r\n"+
				...
				.append("	/**\r\n"+
						...
						"   })\r\n"+
						"	int get"+javaBeanClassName+"Count(@Param(\"belongToId\")int belongToId,@Param(\"findKey\")String findKey);\r\n")
				.append("	/**\r\b"+
						...
						"   })\r\n"+
						"	List<"+javaBeanClassName+"> getAll"+javaBeanClassName+"List(@Param(\"belongToId\")int belongToId,@Param(\"findKey\")String findKey,@Param(\"offset\")int offset,@Param(\"pageCount\")int pageCount);\r\n");
		jbString.append("}\r\n");
		jbString.append("//");
	...
	private void createJavaServiceImplFile(String tableName, String serviceImplFileUrl,String packageName) {
		...
		jbString.append("	/**\r\n" +
				...
				.append("	/**\r\n"+
						...
						"    */\r\n"+
						"   @Override\r\n"+
						"	public int get"+javaBeanClassName+"Count(int belongToId,String findKey){\r\n")
				...
				.append("	/**\r\n"+
						...
						"    */\r\n"+
						"   @Override\r\n"+
						"	public List<"+javaBeanClassName+"> getAll"+javaBeanClassName+"List(int belongToId,String findKey,int offset,int pageCount){\r\n")
	...
	private void createJavaServiceFile(String tableName, String serviceFileUrl,String packageName) {
		...
		jbString.append("	/**\r\n" +
				...
				.append("	/**\r\n"+
						...
						"	 * @return 查找到的记录总数\r\n" +
						"    */\r\n"+
						"	int get"+javaBeanClassName+"Count(int belongToId,String findKey);\r\n")
				.append("	/**\r\n"+
						"	 * 分页方法获取"+tableComment+"信息列表\r\n" +
						"    * @param belongToId "+tableComment+"所属者的ID\r\n" +
						"    * @param findKey "+tableComment+" 信息关键字\r\n" +
						...
						"    * @return "+tableComment+"数据列表\r\n" +
						"    */\r\n"+
						"	List<"+javaBeanClassName+"> getAll"+javaBeanClassName+"List(int belongToId,String findKey,int offset,int pageCount);\r\n");
		jbString.append("}\r\n");
		jbString.append("//");
	...
	private void createJavaControllerFile(String tableName, String controllerFileUrl,String packageName) {
		...
		jbString.append("    /**\r\n" +
				...
				.append("    @ApiImplicitParams({\r\n" +
						"        @ApiImplicitParam(paramType=\"query\", name = \"id\", value = \"所属者的id\", required = true, dataType = \"Integer\"),\r\n" +
						...
						"    })\r\n")
				.append("    public ReturnValue getAll"+javaBeanClassName+"List(@RequestParam Integer belongToId,@RequestParam(request=false,defalutValue=\"\") String findKey,Integer indexOfPage,Integer pageCount) {\r\n" +
						"		try {\r\n" +
						"           //根据页码得到当前需要显示的记录数\n" +
