package com.fpp.code.fxui.fx.component;

import cn.hutool.core.util.ObjectUtil;
import com.fpp.code.fxui.common.FxmlUtil;
...
public class FxDialog<T> {
    ...
    public T show() {
        ...
        throw new IllegalArgumentException("bodyFxmlPath 和 body 不能都为空");
    }
    ...
    private Stage createStage(Parent content) {
        ...
        if (ObjectUtil.isNotEmpty(this.buttonTypes)) {
